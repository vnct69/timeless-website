        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-4 text-sm text-gray-600 text-center">
              ...
              <p>Expires: {formatDate(new Date(event.qr_code_expiry))}</p>
              {isExpired && (
                <p className="text-red-600 font-medium mt-2">⚠️ This QR code has expired</p>
              )}
            </div>
            {/* ✅ QRCodeActions is a Client Component - handles all onClick */}
            <QRCodeActions 
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <dl className="space-y-3">
            ...
            <div>
              ...
              <dd className="text-gray-900 text-lg font-semibold">{attendanceCount || 0} scans</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500">Created</dt>
              <dd className="text-gray-900">{formatDate(new Date(event.created_at))}</dd>
            </div>
          </dl>

          <div className="mt-6 border-t pt-6">
            <h3 className="text-sm font-medium text-gray-700 mb-2">Admin Actions</h3>
            {/* ✅ EventActions is a Client Component - handles all onClick */}
            <EventActions 
              event={event}
