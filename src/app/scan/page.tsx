...
export default function DashboardScanPage() {
  ...
  const handleManualEntry = () => {
    ...
    setError('Manual entry coming soon. Please use the QR scanner at the event location.')
  }
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-2">Scan QR Code</h1>
          <p className="text-gray-600">Scan the event QR code to mark your attendance</p>
        </div>
